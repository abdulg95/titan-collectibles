...
BIO_LONG = (
    ...
    "Becoming an archer in family immersed in the sport is one thing, but becoming a record-breaking bowman "
    "is something else, but since Mete first picked up a bow to begin practicing in 2010 he seems to have "
    "been on the fast-track to the very pinnacle of the sport.\n\nThe right-handed recurve bow shooter first "
    "dipped his toes into the waters of international competition in 2013 and won his first of many "
    "international medals the very same year when he was part of the when he was part of the silver "
    "medal-winning Turkish team at the 2013 World Youth Archery Championship. A year later he claimed silver "
    "at the 2014 Youth Olympic Games in China. Just two years later he was competing for Türkiye on the full "
    "Olympic stage in Rio 2016."
)
...
def main():
    with app.app_context():
        ...
        print('bio_short preview:', repr(mete.bio_short[:120]))
        print('bio_long preview:', repr(mete.bio_long[:160]))
